...
@section('content')
        ...
        <div class="projects p-20 bg-white rad-10 m-20">
          <div class=" d-flex justify-content-between align-items-center">
              ...
              <a data-href="{{ route('dashboard.user.create') }}" data-container="#dash-table-modal"
            ...
            <table class="fs-15 w-full">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    @if($user->image)
                      <img src="{{asset('storage/uploads/users/images/'. $user->image)}}" alt="image" width="50" height="50">
                    @else
                      <img src="{{asset('storage/uploads/users/images/default.png')}}" alt="image" width="50" height="50">
                    @endif
                  </td>
                  <td>
                    <a data-href="{{route('dashboard.user.edit',$user->id )}}" data-container="#dash-table-modal"
                    ...
                    <a href="{{route('dashboard.user.destroy', $user->id)}}" data-url="{{route('dashboard.user.destroy', $user->id)}}" class="btn delete-item  sw-alert btn-sm"><svg width="20"
