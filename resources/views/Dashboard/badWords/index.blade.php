...
@section('content')
        ...
        <div class="projects p-20 bg-white rad-10 m-20">
          <div class=" d-flex justify-content-between align-items-center">
              <a data-href="{{ route('dashboard.badWord.create') }}" data-container="#dash-table-modal"
                class="btn primary-btn  remove-marg btn-modal submit-btn mb-2  ">
            ...
            <table class="fs-15 w-full">
              ...
              <tbody>
                ...
                <tr>
                  <td>{{$word->title}}</td>
                  <td>
                    <a data-href="{{route('dashboard.badWord.edit',$word->id )}}" data-container="#dash-table-modal"
                    ...
                    <a href="{{route('dashboard.badWord.destroy', $word->id)}}" data-url="{{route('dashboard.badWord.destroy', $word->id)}}" class="btn delete-item  sw-alert btn-sm"><svg width="20"
